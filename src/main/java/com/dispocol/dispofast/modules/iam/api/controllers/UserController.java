...
public class UserController {
  ...
  @GetMapping
  public ResponseEntity<Page<UserResponseDTO>> getUsers(@PageableDefault(size = 20, sort = "name") Pageable pageable) {
  ...
  public ResponseEntity<UserPermissionsDetailDTO> updateUserPermissions(
      @PathVariable UUID id,
      @Valid @RequestBody UpdateUserPermissionRequestDTO dto) {
