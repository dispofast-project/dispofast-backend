...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponseDTO> createCustomer(@RequestBody CreateCustomerRequestDTO entity) {
        return ResponseEntity.ok(customerService.createCustomer(entity));
    }

    @GetMapping()
    public ResponseEntity<Page<CustomerResponseDTO>> getCustomersPaged(@RequestParam int page, @RequestParam int size) {
