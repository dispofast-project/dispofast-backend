...
public interface ProductMapper {
  ...
  @Mapping(
      target = "reference",
      expression =
          "java(dto.getReference() != null && !dto.getReference().isBlank() ? dto.getReference().trim().toUpperCase() : null)")
  @Mapping(
      target = "size",
      expression =
          "java(dto.getSize() != null && !dto.getSize().isBlank() ? dto.getSize().trim() : null)")
