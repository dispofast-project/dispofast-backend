...
public class QuoteController {
    ...
    @PostMapping
    public ResponseEntity<QuoteResponseDTO> createQuote(@RequestBody CreateQuoteRequestDTO createQuoteRequestDTO) {
        return new ResponseEntity<>(quoteService.createQuote(createQuoteRequestDTO), HttpStatus.CREATED);
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<QuoteResponseDTO> updateQuote(@PathVariable UUID id,
            @RequestBody UpdateQuoteRequestDTO updateQuoteRequestDTO) {
