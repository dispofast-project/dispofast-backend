...
CREATE TABLE IF NOT EXISTS sales_order (
    ...
    CONSTRAINT fk_order_city       FOREIGN KEY (shipment_city_id) REFERENCES cities(code),
    CONSTRAINT fk_order_price_list FOREIGN KEY (price_list_id)    REFERENCES price_lists(id),
...
CREATE INDEX IF NOT EXISTS idx_sales_order_client_id      ON sales_order(client_id);
